...
public class WxCreateService extends WxBaseService{
	...
	protected Map<String,Object> callCreateCard(String json) throws IOException{
		String createUrl=getRealyUrl(PropertiesUtil.getPropertyPath("weixin.card_create"));
	 ...
	 * @throws IOException 
	 */
	public Map<String,Object> setPayCell(String CardId,boolean isOpen) throws IOException{
		String payCellUrl=getRealyUrl(PropertiesUtil.getPropertyPath("weixin.paycell"));
	...
	public boolean setPayCellToJson(String CardId,boolean isOpen) throws IOException{
		String payCellUrl=getRealyUrl(PropertiesUtil.getPropertyPath("weixin.paycell"));
		Map<String,Object> paramMap=new HashMap<String, Object>();
		paramMap.put("card_id", CardId);
		paramMap.put("is_open", isOpen);
		Map<String,Object> resultMap = excutePost(payCellUrl, JSONObject.toJSONString(paramMap));
	 ...
	 * @throws IOException 
	 */
	public Map<String,Object> setSelfconsumecell(String CardId,boolean isOpen) throws IOException{
		String selfconsumecellUrl=getRealyUrl(PropertiesUtil.getPropertyPath("weixin.selfconsumecell"));
		Map<String,Object> paramMap=new HashMap<String, Object>();
		paramMap.put("card_id", CardId);
		paramMap.put("is_open", isOpen);
		return excutePost(selfconsumecellUrl, JSONObject.toJSONString(paramMap));
	}
	public boolean setSelfconsumecellToJson(String CardId,boolean isOpen) throws IOException{
		String selfconsumecellUrl=getRealyUrl(PropertiesUtil.getPropertyPath("weixin.selfconsumecell"));
		Map<String,Object> paramMap=new HashMap<String, Object>();
		paramMap.put("card_id", CardId);
		paramMap.put("is_open", isOpen);
		Map<String,Object> resultMap = excutePost(selfconsumecellUrl, JSONObject.toJSONString(paramMap));
		if (resultMap.get("errcode")!=null) {
			if (StringUtils.equals(resultMap.get("errcode").toString(), "0")) {
				return true;
			}
